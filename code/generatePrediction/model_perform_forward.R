...
forw.save0 <- list(p, po,exp.freq.cv, obs.freq.cv, pat_prob_save)
save(forw.save0, 
     file = paste0("paperPrep/finalizedCode/figs/calibration/forw_di=", '0',".RData"))
...
forw.save8 <- list(p, po,exp.freq.cv, obs.freq.cv, pat_prob_save)

save(forw.save8, 
     file = paste0("paperPrep/finalizedCode/figs/calibration/forw_di=", i,".RData"))
